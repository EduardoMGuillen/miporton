  ...
  return (
    <Card>
      ...
      <p className="mt-2 text-sm text-slate-600">
        Activa un aviso para todos los usuarios (residentes, guardias, administradores y visitantes en login). Ideal para
        mantenimientos o noticias urgentes. El texto se muestra en rojo en la parte superior de todas las pantallas.
      </p>
      <div className="mt-4">
        <SiteBannerForm enabled={row?.enabled ?? false} message={row?.message ?? ""} />
      </div>
    </Card>
  );
}
